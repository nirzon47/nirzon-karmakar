...
export const MacbookScroll = ({ showGradient }: { showGradient?: boolean }) => {
	...
	return (
		<div
			ref={ref}
			className='min-h-screen flex flex-col items-center py-0 md:py-40 justify-start flex-shrink-0 [perspective:600px] transform md:scale-100 scale-[0.4] sm:scale-50'
		>
			<motion.h2
				style={{
			...
			<div className='h-[22rem] w-[32rem] bg-[#272729] rounded-2xl overflow-hidden relative -z-10'>
				...
				{showGradient && (
					<div className='h-40 w-full absolute bottom-0 inset-x-0 bg-gradient-to-t from-black via-white to-transparent z-50'></div>
				)}
			</div>
		</div>
	)
	...
	return (
		<div className='relative [perspective:800px]'>
			...
			>
				...
				>
					<span className='text-white'>Nirzon Taru Karmakar</span>
				</div>
			</div>
			<motion.div
				style={{
				...
				className='h-96 w-[32rem] absolute inset-0 bg-[#272729] rounded-2xl p-2'
			>
				<motion.div className='absolute inset-0 bg-[#040413] rounded-lg grid grid-flow-col grid-rows-1 items-center gap-8 overflow-y-hidden overflow-x-scroll scrollbar-hide ring-1'>
					<ProjectSlider />
				</motion.div>
			</motion.div>
		</div>
